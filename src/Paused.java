...
public class Paused extends MouseAdapter {
    ...
    public void render(Graphics g){
        ...
        g.setFont(mainFont);
        g.drawString("PAUSED", Game.WIDTH/2 - 130, 150);

        g.drawRect(Game.WIDTH/2 - 175, 250, 350, 100);
        g.drawString("Continue", Game.WIDTH/2 - 130, 320);

        g.drawRect(Game.WIDTH/2 - 175, 450, 350, 100);
        g.drawString("New Game", Game.WIDTH/2 - 140, 520);

        g.drawRect(Game.WIDTH/2 - 175, 650, 350, 100);
        g.drawString("Quit", Game.WIDTH/2 - 70, 720);
    }
}